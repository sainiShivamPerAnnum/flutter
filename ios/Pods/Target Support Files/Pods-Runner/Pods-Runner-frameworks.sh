...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/app_install_date/app_install_date.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_facebook_sdk/flutter_facebook_sdk.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/webengage_flutter/webengage_flutter.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/WebEngage/XCFramework/WebEngage.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/paytm_allinonesdk/AppInvokeSDK.framework"
