class QuoteModel {
  ...
  static const _flowQuotes = [
    QuoteModel._(
      icon: "https://d11q4cti75qmcp.cloudfront.net/imagekit/Quotes/map.png",
      quote:
    ...
    QuoteModel._(
      icon: "https://d11q4cti75qmcp.cloudfront.net/imagekit/Quotes/donut.png",
      quote:
    ...
    QuoteModel._(
      icon: "https://d11q4cti75qmcp.cloudfront.net/imagekit/Quotes/popcorn.png",
      quote:
    ...
    QuoteModel._(
      icon: "https://d11q4cti75qmcp.cloudfront.net/imagekit/Quotes/food.png",
      quote:
  ...
  static const _digitalGoldQuotes = [
    ...
    QuoteModel._(
      icon:
          "https://d11q4cti75qmcp.cloudfront.net/imagekit/Quotes/flower_pot.png",
      quote:
    ...
    QuoteModel._(
      icon: "https://d11q4cti75qmcp.cloudfront.net/imagekit/Quotes/fleur.png",
      quote:
    ...
    QuoteModel._(
      icon: "https://d11q4cti75qmcp.cloudfront.net/imagekit/Quotes/crown.png",
      quote:
