                  ...
                  Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          // width: 278,
                          height: index == 0 ? 114 : null,
                          padding: EdgeInsets.symmetric(
                              horizontal: SizeConfig.padding12,
                              vertical: SizeConfig.padding12),
                          decoration: ShapeDecoration(
                            color: const Color(0xFFF79780).withOpacity(
                              0.20,
                            ),
                            shape: RoundedRectangleBorder(
...
// CustomPaint(
// size: Size(WIDTH, (WIDTH*0.30666666666666664).toDouble()), //You can Replace [WIDTH] with your desired width for Custom Paint and height will be calculated automatically
