...
import 'package:felloapp/feature/hms_room_kit/lib/src/model/participant_store.dart';
import 'package:felloapp/feature/hms_room_kit/lib/src/model/peer_track_node.dart';
import 'package:felloapp/feature/hms_room_kit/lib/src/widgets/bottom_sheets/change_role_bottom_sheet.dart';
import 'package:felloapp/feature/hms_room_kit/lib/src/widgets/bottom_sheets/participants_view_all_bottom_sheet.dart';
                                                                            ...
                                                                            return participantData.item1 != -1 && participantData.item1 < 3 && participantData.item2
                                                                                ? Padding(
                                                                                    ...
                                                                                    child: CircleAvatar(
                                                                                      ...
                                                                                      backgroundColor: HMSThemeColors.surfaceDefault,
                                                                                      child: SvgPicture.asset(
                                                                                        "assets/hms/icons/network_${participantData.item1}.svg",
                                                                                        height: 12,
                                                                                        width: 12,
                                                                                      ),
                                                                                    ),
