...
import 'package:felloapp/feature/hms_room_kit/lib/src/widgets/chat_widgets/chat_text_field.dart';
                        ...
                        child: Selector<MeetingStore,
                          ...
                          builder: (context, data, _) {
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (_, index) {
                                final datauser = jsonDecode(data.item1[index].sender!.metadata??'{}');
                                return Row(
                                  mainAxisAlignment:
                    ...
                    return isChatEnabled
                        ? Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                //todo remove this to send message only to everyone
                                if ((HMSRoomLayout
