...
class HLSPlayerStore extends ChangeNotifier
  ...
  Duration timeFromLive = const Duration(milliseconds: 0);

  ///This variable stores the stream rolling window time
  Duration rollingWindow = const Duration(milliseconds: 0);
  ...
  Size hlsPlayerSize = const Size(1, 1);
  ...
  Future<void> areClosedCaptionsSupported() async {
  ...
  Future<void> getStreamProperties() async {
  ...
  Future<void> getHLSLayers() async {
  ...
  Future<void> getCurrentHLSLayer() async {
  ...
  Future<void> setHLSLayer(HMSHLSLayer hmsHLSLayer) async {
