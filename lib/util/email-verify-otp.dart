                                    ...
                                    <div style="width: 100% !important;">
                                        <div
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:25px 10px 13px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                                                ...
                                                                <tr>
                                                                    <td style="padding-right: 0px;padding-left: 0px;"
                                                                        ...
                                                                        <img align="center" border="0"
                                                                            src="https://fello.in/src/images/fello_logo_2_grey.png"
                                    ...
                                    <div style="width: 100% !important;">
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:20px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 25px 10px;font-family:'Open Sans',sans-serif;"
                                                            align="left">
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:25px 10px 30px;font-family:'Open Sans',sans-serif;"
                                                            align="left">

                                                            <div
                                                                style="color: #333333; line-height: 140%; text-align: center; word-wrap: break-word;">
                                                                <p style="font-size: 14px; line-height: 140%;"><span
                                                                        style="font-size: 22px; line-height: 30.8px;">Your
                                                                        OTP is</span></p>
                                                            </div>
                                ...
                                <div class="u-col u-col-100"
                                    ...
                                    <div style="width: 100% !important;">
                                        <div
                                            ...
                                            <table id="u_content_button_4" style="font-family:'Open Sans',sans-serif;"
                                    ...
                                    <div style="width: 100% !important;">
                                        <div
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 50px 10px;font-family:'Open Sans',sans-serif;"
                                                            align="left">

                                                            <div
                                                                style="line-height: 180%; text-align: left; word-wrap: break-word;">
                                                                <p
                                                                    style="line-height: 180%; text-align: center; font-size: 14px;">
                                                                    <span style="font-family: Lato, sans-serif;"><span
                                                                            style="font-size: 16px; line-height: 28.8px;">For
                                                                            any queries, please reach out
                                                                            through </span></span></p>
                                                                <p
                                                                    style="line-height: 180%; text-align: center; font-size: 14px;">
                                                                    <span style="font-family: Lato, sans-serif;"><span
                                                                            style="font-size: 16px; line-height: 28.8px;">any
                                            ...
                                            <table style="font-family:'Open Sans',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px;font-family:'Open Sans',sans-serif;"
                                                            align="left">

                                                            <table height="0px" align="center" border="0"
                                                                cellpadding="0" cellspacing="0" width="72%"
                                                                    ...
                                                                    <table align="left" border="0" cellspacing="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://wa.me/${917993252690}/?text=Hello Fello"
                                                                                        title="WhatsApp"
                                                                                        target="_blank">
                                                                    ...
                                                                    <table align="left" border="0" cellspacing="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="left" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                                                    <a href="https://www.linkedin.com/company/fellofinance/?originalSubdomain=in"
                                                                                        title="LinkedIn"
                                                                                        target="_blank">
                                                                                        <img src="https://www.raulvelazquezphd.com/wp-content/uploads/2017/10/LinkedIn-1.png"
                                                                                            alt="LinkedIn"
