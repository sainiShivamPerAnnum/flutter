...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(Value) => " and ${Value} Fello tokens.";

  static String m3(amount) =>
      "By continuing, ₹${amount} will be credited to your linked bank account";

  static String m4(currentDay) => "Claim day ${currentDay} Reward";

  static String m5(percentage) => "+ ${percentage}% Returns";

  static String m6(multiplier, percent) =>
      "Get *\$${multiplier}X tickets* on saving in ${percent}% Flo till maturity";

  static String m7(prizeAmount) => "Win upto Rs.${prizeAmount}";

  static String m8(Value) => "Get 1 Ticket for every ₹${Value} saved";

  static String m9(tickets) => "Get ${tickets}X Tickets";

  static String m10(interest) => "${interest}%";

  static String m11(index) => "Milestone ${index}";

  static String m12(percentage) => "Loosing Extra ${percentage}%";

  static String m13(amount) => "Upto ₹ ${amount} can be invested at one go";

  static String m14(amount) => "Maximum amount - ₹${amount}";

  static String m15(amount) => "Min - ₹${amount}";

  static String m16(amount) => "Minimum purchase amount is ₹ ${amount} ";

  static String m17(amount) => "Minimum amount - ₹${amount}";

  static String m18(name) => "Hi ${name}";

  static String m19(mobileNumber) => "Login as +91-${mobileNumber}";

  static String m20(interest) => "${interest}%";

  static String m21(percentage) => "with ${percentage}% returns";

  static String m22(prizeAmount) =>
      "I\'ve won ₹\$${prizeAmount} as\nDigital Gold on Fello!";

  static String m23(i) => "Prize \$${i}";
  ...
  static String m27(amount) => "Claim ${amount} referral bonus by saving";

  static String m28(servingSize) => "*Based on ${servingSize} fl. oz serving.";
  ...
  static String m31(type) => "with Fello ${type}";

  static String m32(goldAmount) => "${goldAmount} gm";
  ...
  static String m35(count) => "Tickets ${count}";

  static String m36(cost) => "SKIP WITH ${cost} TOKENS";

  static String m37(date) => "Started on ${date}";

  static String m38(prize) => "Complete ${prize} to get ";

  static String m39(ticketGenerateCount) =>
      "of your ${ticketGenerateCount} tickets";

  static String m40(multiplicationFactor) => "${multiplicationFactor}X Tickets";

  static String m41(username) =>
      "Your username ${username} has been successfully registered!";

  static String m42(interest) => "${interest} % Returns on your investment";

  static String m43(ticketType, rewardAmount) =>
      "Win a ${ticketType} Card worth upto ₹${rewardAmount}";

  static String m44(prize) => "Winnings can be redeemed on reaching ₹${prize}";

  static String m45(timePeriod) => "Your Money in ${timePeriod} Years";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "KyclinkedAccount": MessageLookupByLibrary.simpleMessage("Linked Account"),
    ...
    "SipCarTitle": MessageLookupByLibrary.simpleMessage("SIP For a Car"),
    "SipIphoneTitle": MessageLookupByLibrary.simpleMessage("SIP for an Iphone"),
    ...
    "addAmountCoupons": MessageLookupByLibrary.simpleMessage("Add Amount"),
    ...
    "annualInterest": MessageLookupByLibrary.simpleMessage("Annual Interest"),
    ...
    "autoSaveDetails": MessageLookupByLibrary.simpleMessage("Autosave Details"),
    ...
    "autoSipText": MessageLookupByLibrary.simpleMessage("AUTO SIP"),
    ...
    "bankAccNoTitle": MessageLookupByLibrary.simpleMessage(
      "Bank Account Number",
    ),
    ...
    "bankHolderName": MessageLookupByLibrary.simpleMessage(
      "Bank Holder\'s Name",
    ),
    ...
    "boxFloTitles1": MessageLookupByLibrary.simpleMessage(
    ...
    "btnCongratulations": MessageLookupByLibrary.simpleMessage(
      "Congratulations!",
    ),
    ...
    "btnGetStarted": MessageLookupByLibrary.simpleMessage("Get Started"),
    "btnGrantPermission": MessageLookupByLibrary.simpleMessage(
      "Grant Permission",
    ),
    ...
    "btnSetupAutoSave": MessageLookupByLibrary.simpleMessage("Setup Autosave"),
    ...
    "btnStartPlaying": MessageLookupByLibrary.simpleMessage("Start Playing"),
    ...
    "couldHaveGrown": MessageLookupByLibrary.simpleMessage(
      "could have grown to ",
    ),
    ...
    "currentTokens": MessageLookupByLibrary.simpleMessage("Current Tokens:"),
    "currentValue": MessageLookupByLibrary.simpleMessage("Current Amount"),
    "currentWinings": MessageLookupByLibrary.simpleMessage("Current Winnings"),
    ...
    "editSip": MessageLookupByLibrary.simpleMessage("Edit SIP"),
    "editSipOptions": MessageLookupByLibrary.simpleMessage("Edit SIP Options"),
    "editSipbtn": MessageLookupByLibrary.simpleMessage("Edit SIP"),
    ...
    "enjoyingFello": MessageLookupByLibrary.simpleMessage("Enjoying Fello?"),
    ...
    "existingSip": MessageLookupByLibrary.simpleMessage("Your Existing SIP"),
    ...
    "felloP2P": MessageLookupByLibrary.simpleMessage("Fello P2P"),
    "felloRewards": MessageLookupByLibrary.simpleMessage("Fello Rewards"),
    ...
    "fieldsMismatch": MessageLookupByLibrary.simpleMessage("Fields mismatch"),
    "fiftyFelloTokens": MessageLookupByLibrary.simpleMessage(
      "50 Fello\nTokens",
    ),
    ...
    "floAutoInvest": MessageLookupByLibrary.simpleMessage(
      "Auto Invest on Maturity",
    ),
    "floCurrentReturn": MessageLookupByLibrary.simpleMessage("Current Return"),
    "floEarn10Percent": MessageLookupByLibrary.simpleMessage(
      "Earn 10% returns",
    ),
    "floInvested": MessageLookupByLibrary.simpleMessage("Invested"),
    "floPortFolio": MessageLookupByLibrary.simpleMessage("Fello P2P Portfolio"),
    ...
    "floTicketEarningOnAsset": m6,
    "forTheRequest": MessageLookupByLibrary.simpleMessage("for the request."),
    "formats": MessageLookupByLibrary.simpleMessage("Formats: PNG, JPEG, JPG"),
    ...
    "getMoreTokens": MessageLookupByLibrary.simpleMessage("Get More Tokens"),
    ...
    "goldPurchased": MessageLookupByLibrary.simpleMessage("Gold Purchased:"),
    ...
    "goldSip": MessageLookupByLibrary.simpleMessage("Digital Gold SIP"),
    ...
    "highestSaving": MessageLookupByLibrary.simpleMessage("Highest\nSaving"),
    ...
    "howFelloP2PWorks": MessageLookupByLibrary.simpleMessage(
      "How Fello P2P Works?",
    ),
    ...
    "howToParticipate": MessageLookupByLibrary.simpleMessage(
      "How to participate",
    ),
    "howtoearn": MessageLookupByLibrary.simpleMessage("How to Earn Rewards"),
    "hurray": MessageLookupByLibrary.simpleMessage("Hurray!"),
    "icici": MessageLookupByLibrary.simpleMessage("ICICI Prudential Fund"),
    ...
    "inSufficientBal": MessageLookupByLibrary.simpleMessage(
    ...
    "interest": m10,
    "interestOnGold": MessageLookupByLibrary.simpleMessage("Interest\non Gold"),
    ...
    "invalidUsername": MessageLookupByLibrary.simpleMessage("Username invalid"),
    ...
    "jFailed": MessageLookupByLibrary.simpleMessage("Journey failed to load"),
    ...
    "jSkipMileStone": MessageLookupByLibrary.simpleMessage("SKIP MILESTONE"),
    ...
    "jstAClickAway": MessageLookupByLibrary.simpleMessage("Just a click away"),
    "keepInvestingText": MessageLookupByLibrary.simpleMessage(
      "Keep investing, keep playing and win big!",
    ),
    "kycComplete": MessageLookupByLibrary.simpleMessage("Congratulations"),
    "kycCompleteSub": MessageLookupByLibrary.simpleMessage(
      "On completing your KYC",
    ),
    "kycEmailProceed": MessageLookupByLibrary.simpleMessage("VERIFY EMAIL"),
    ...
    "kycStep1": MessageLookupByLibrary.simpleMessage("Step 1 - Verify Email"),
    ...
    "lastWeekFello": MessageLookupByLibrary.simpleMessage("Last Week on Fello"),
    ...
    "lockInTill": MessageLookupByLibrary.simpleMessage("Lock-in till"),
    "loosingReturns": m12,
    ...
    "maxAmountMessage": m13,
    "maxSipAmount": m14,
    "maxSize": MessageLookupByLibrary.simpleMessage("Max size: 5 MB"),
    ...
    "noUpiAppFound": MessageLookupByLibrary.simpleMessage("No upi apps found"),
    "notSaved": MessageLookupByLibrary.simpleMessage("Have not saved"),
    ...
    "obAppUpdate": MessageLookupByLibrary.simpleMessage("App Update Required"),
    ...
    "obBlockedAb": MessageLookupByLibrary.simpleMessage("Account Information"),
    ...
    "obChangeAvatar": MessageLookupByLibrary.simpleMessage(
      "Change your avatar",
    ),
    ...
    "obCompleteProfile": MessageLookupByLibrary.simpleMessage(
      "Complete Profile",
    ),
    ...
    "obDidntGetOtp": MessageLookupByLibrary.simpleMessage("Didn\'t receive? "),
    ...
    "obKYCDetailsLabel": MessageLookupByLibrary.simpleMessage("KYC Details"),
    "obLoading": MessageLookupByLibrary.simpleMessage("Loading..."),
    "obLoggingInWith": MessageLookupByLibrary.simpleMessage("Logging in with"),
    "obLoginAsText": m19,
    ...
    "obOtpRequest": MessageLookupByLibrary.simpleMessage("Resend OTP in "),
    ...
    "obPreferNotToSay": MessageLookupByLibrary.simpleMessage("Rather Not Say"),
    ...
    "obTermsofService": MessageLookupByLibrary.simpleMessage(
      "Terms of Service",
    ),
    ...
    "obUserNameHint": MessageLookupByLibrary.simpleMessage("Your username"),
    "obUsernameHint": MessageLookupByLibrary.simpleMessage("Enter a username"),
    ...
    "onboardingTitle2": MessageLookupByLibrary.simpleMessage("Play fun games"),
    "onboardingTitle3": MessageLookupByLibrary.simpleMessage("Win Rs.1 Crore!"),
    ...
    "oneScratchCard": MessageLookupByLibrary.simpleMessage("1 Scratch\nCard"),
    "oneWeek": MessageLookupByLibrary.simpleMessage("1 Week"),
    "onreinvestment": MessageLookupByLibrary.simpleMessage(" on reinvestment"),
    ...
    "p2pCalculator5YearsReturns": MessageLookupByLibrary.simpleMessage(
      "Your Amount on maturity-",
    ),
    "p2pCalculatorInvestmentAmount": MessageLookupByLibrary.simpleMessage(
      "Investment Amount -",
    ),
    "p2pCalculatorInvestmentDuration": MessageLookupByLibrary.simpleMessage(
      "Time Period -",
    ),
    "p2pCalculatorInvestmentDurationUnit": MessageLookupByLibrary.simpleMessage(
      "Year",
    ),
    "p2pReturnsCalculatorSubtitle": MessageLookupByLibrary.simpleMessage(
      "Calculate your Returns",
    ),
    "p2pReturnsCalculatorTitle": MessageLookupByLibrary.simpleMessage(
      "Return Calculator",
    ),
    ...
    "panUploaded": MessageLookupByLibrary.simpleMessage("PAN Card Uploaded"),
    "panVerifyFailed": MessageLookupByLibrary.simpleMessage(
    ...
    "pauseFail": MessageLookupByLibrary.simpleMessage("Failed to pause SIP"),
    ...
    "perAnnum": MessageLookupByLibrary.simpleMessage("Per annum"),
    "perAnnumLabel": MessageLookupByLibrary.simpleMessage("per annum"),
    ...
    "powerPlaySlog": MessageLookupByLibrary.simpleMessage(
      "Predict | Save | Win",
    ),
    ...
    "rbiCertified": MessageLookupByLibrary.simpleMessage("RBI Certified"),
    "reInvestOnMaturity": MessageLookupByLibrary.simpleMessage(
    ...
    "refBonus": MessageLookupByLibrary.simpleMessage("Referral Bonus"),
    ...
    "refEmpty": MessageLookupByLibrary.simpleMessage("No referrals yet"),
    ...
    "refHaveReferral": MessageLookupByLibrary.simpleMessage(
      "Have a referral code?",
    ),
    "refInvalid": MessageLookupByLibrary.simpleMessage("Invalid referral code"),
    ...
    "referFriends": MessageLookupByLibrary.simpleMessage("Refer your friends"),
    "referralNudgeMessage": m27,
    "referrals": MessageLookupByLibrary.simpleMessage("referrals"),
    "referralsTitle": MessageLookupByLibrary.simpleMessage("Referrals"),
    "refreshKYC": MessageLookupByLibrary.simpleMessage("Please refresh"),
    ...
    "reqPermission": MessageLookupByLibrary.simpleMessage("Request Permission"),
    ...
    "resumeAutoSave": MessageLookupByLibrary.simpleMessage("Resume Autosave"),
    ...
    "rewardsEmpty": MessageLookupByLibrary.simpleMessage("No Rewards won"),
    "rewardsRedemeed": MessageLookupByLibrary.simpleMessage("Rewards Redeemed"),
    "rewardsWithFello": MessageLookupByLibrary.simpleMessage(
      "Rewards with Fello",
    ),
    "rewardsWon": MessageLookupByLibrary.simpleMessage("Reward won"),
    "rpSip": MessageLookupByLibrary.simpleMessage("Return Percentage"),
    ...
    "savingsMade": MessageLookupByLibrary.simpleMessage("Savings made"),
    ...
    "scratchCardText": MessageLookupByLibrary.simpleMessage("Scratch Cards"),
    "scratchCards": MessageLookupByLibrary.simpleMessage("Scratch Cards"),
    "scratchCardsSip": MessageLookupByLibrary.simpleMessage("Scratch Card"),
    "sctab1": MessageLookupByLibrary.simpleMessage("Your Rewards"),
    "sctab2": MessageLookupByLibrary.simpleMessage("Earn Rewards"),
    "secureFelloTitle": MessageLookupByLibrary.simpleMessage("Secure Fello"),
    ...
    "selectGmail": MessageLookupByLibrary.simpleMessage("Select an account"),
    "selectRating": MessageLookupByLibrary.simpleMessage(
      "Please select a rating",
    ),
    "selectSipAmount": MessageLookupByLibrary.simpleMessage(
      "Select SIP amount",
    ),
    ...
    "sellCardTitle2": MessageLookupByLibrary.simpleMessage("Withdraw from Flo"),
    ...
    "setUpAutoSave": MessageLookupByLibrary.simpleMessage("SETUP AUTO SAVE"),
    "setUpMandate": MessageLookupByLibrary.simpleMessage("Set up UPI Mandate:"),
    ...
    "setupSip": MessageLookupByLibrary.simpleMessage("Setup SIP"),
    ...
    "signInFailedText": MessageLookupByLibrary.simpleMessage("Sign In Failed"),
    ...
    "sipGt": MessageLookupByLibrary.simpleMessage("Scratch Card"),
    ...
    "sipReturn": m34,
    "sipSummary": MessageLookupByLibrary.simpleMessage("Your SIP Summary"),
    "sipText": MessageLookupByLibrary.simpleMessage("SIP"),
    "sipTicket": MessageLookupByLibrary.simpleMessage("Tickets"),
    "sipTickets": m35,
    ...
    "startSavingNow": MessageLookupByLibrary.simpleMessage("Start saving now"),
    "startSip": MessageLookupByLibrary.simpleMessage("START SIP"),
    "startedSip": m37,
    ...
    "tDrawTime": MessageLookupByLibrary.simpleMessage("Today’s draw at 6 PM "),
    "tDrawnAtText1": MessageLookupByLibrary.simpleMessage(
      "Will be drawn at 6pm",
    ),
    "tDrawnAtText2": MessageLookupByLibrary.simpleMessage("Drawn at 6pm"),
    ...
    "tFullHouse": MessageLookupByLibrary.simpleMessage("Full House"),
    "tGeneratedOn": MessageLookupByLibrary.simpleMessage("Generated on :"),
    "tGetMore": MessageLookupByLibrary.simpleMessage("Get more tickets"),
    "tGetTickets": MessageLookupByLibrary.simpleMessage("+ Get Tickets"),
    "tHowToPlay": MessageLookupByLibrary.simpleMessage("How to play"),
    "tLeft": MessageLookupByLibrary.simpleMessage(" left"),
    ...
    "tMiddleRow": MessageLookupByLibrary.simpleMessage("Middle Row"),
    ...
    "tOneTicket": MessageLookupByLibrary.simpleMessage(" Ticket"),
    ...
    "tPrizes": MessageLookupByLibrary.simpleMessage("Tambola Prizes"),
    ...
    "tTicketWon": MessageLookupByLibrary.simpleMessage("Tambola ticket won"),
    "tTicketsDeducted": MessageLookupByLibrary.simpleMessage(
      "Tambola Tickets Deducted",
    ),
    "tTicketsWon": MessageLookupByLibrary.simpleMessage("Tambola tickets won"),
    "tTitle": MessageLookupByLibrary.simpleMessage("Tambola"),
    "tTopRow": MessageLookupByLibrary.simpleMessage("Top Row"),
    "tTotalTickets": MessageLookupByLibrary.simpleMessage("Total Tickets: "),
    "tViewAllTicks": MessageLookupByLibrary.simpleMessage("View All Tickets"),
    ...
    "tambolaTicketWinAlert1": MessageLookupByLibrary.simpleMessage(
      "Congratulations 🎉",
    ),
    "tambolaTicketWinAlert2": MessageLookupByLibrary.simpleMessage(
      "Your tickets have been submitted for processing your prizes!",
    ),
    "tambolaWin": MessageLookupByLibrary.simpleMessage("Tambola Win"),
    ...
    "threeClicksAway": MessageLookupByLibrary.simpleMessage("3 CLICKS AWAY"),
    "ticketsEarnedflo": MessageLookupByLibrary.simpleMessage("Tickets Earned"),
    "ticketsExceeded": MessageLookupByLibrary.simpleMessage(
      "Maximum tickets exceeded",
    ),
    "ticketsMatched": MessageLookupByLibrary.simpleMessage("Tickets matched"),
    "ticketsMultiplication": m40,
    ...
    "todaysPicks": MessageLookupByLibrary.simpleMessage("Today\'s Picks are:"),
    ...
    "tokensDeducted": MessageLookupByLibrary.simpleMessage("Tokens Deducted"),
    "tokensRequired": MessageLookupByLibrary.simpleMessage("Tokens Required"),
    "tokensWon": MessageLookupByLibrary.simpleMessage("Tokens won!"),
    "tooManyAttempts": MessageLookupByLibrary.simpleMessage(
      "Too many attempts",
    ),
    "topParticipants": MessageLookupByLibrary.simpleMessage("Top Participants"),
    "topRef": MessageLookupByLibrary.simpleMessage("Top Referrers"),
    "topScroresText1": MessageLookupByLibrary.simpleMessage("This week"),
    "topScroresText2": MessageLookupByLibrary.simpleMessage("s top scorers: "),
    ...
    "toverifyEmail": MessageLookupByLibrary.simpleMessage("to verify email"),
    "transaction": MessageLookupByLibrary.simpleMessage("Transaction"),
    "transactionProgress": MessageLookupByLibrary.simpleMessage(
      "Your transaction is in progress",
    ),
    "transactionSection": MessageLookupByLibrary.simpleMessage("Transactions"),
    ...
    "tryAgainMessage": MessageLookupByLibrary.simpleMessage("Please try again"),
    ...
    "txnActiveCoupon": MessageLookupByLibrary.simpleMessage("Active Coupons"),
    "txnAmountTitle": MessageLookupByLibrary.simpleMessage(
      "Transaction Amount",
    ),
    "txnApply": MessageLookupByLibrary.simpleMessage("Apply"),
    "txnApplyCoupon": MessageLookupByLibrary.simpleMessage("Apply a Coupon"),
    ...
    "txnDetailsTitle": MessageLookupByLibrary.simpleMessage(
      "Transaction Details",
    ),
    "txnDontPressBack": MessageLookupByLibrary.simpleMessage(
      "Do not press back until the payment is completed",
    ),
    "txnEnterAmount": MessageLookupByLibrary.simpleMessage("Enter amount"),
    ...
    "txnEnterUPIFeild": MessageLookupByLibrary.simpleMessage(
    ...
    "txnHistory": MessageLookupByLibrary.simpleMessage("Transaction History"),
    "txnHistoryLabel": MessageLookupByLibrary.simpleMessage(
      "Transaction History",
    ),
    ...
    "txnNoUPI": MessageLookupByLibrary.simpleMessage("No UPI apps available"),
    ...
    "txnStatus": MessageLookupByLibrary.simpleMessage("Transaction Status"),
    "txnTryAfterSomeTime": MessageLookupByLibrary.simpleMessage(
      "Please try in some time",
    ),
    "txnUpdateAmount": MessageLookupByLibrary.simpleMessage("Update amount"),
    "txnVerify": MessageLookupByLibrary.simpleMessage("Verifying transaction"),
    ...
    "txnsPendingUPI": MessageLookupByLibrary.simpleMessage(
    ...
    "updateAutoSave": MessageLookupByLibrary.simpleMessage("UPDATE AUTOSAVE"),
    ...
    "updateSip": MessageLookupByLibrary.simpleMessage("UPDATE SIP"),
    ...
    "uploadModal": MessageLookupByLibrary.simpleMessage("Upload your PAN Card"),
    "uploadPan": MessageLookupByLibrary.simpleMessage("UPLOAD PAN CARD"),
    ...
    "verifyEmailKyc": MessageLookupByLibrary.simpleMessage("Verify your Email"),
    "verifyFailed": MessageLookupByLibrary.simpleMessage("Unable to verify"),
    ...
    "viewSIPTransac": MessageLookupByLibrary.simpleMessage(
      "View SIP Transactions",
    ),
    "viewSip": MessageLookupByLibrary.simpleMessage("VIEW SIP"),
    "waitForNewOTP": MessageLookupByLibrary.simpleMessage(
      "Please wait for the new otp",
    ),
    "wallet": MessageLookupByLibrary.simpleMessage("P2P Wallet"),
    "walletCurrentValueLabel": MessageLookupByLibrary.simpleMessage(
      "Current Value:",
    ),
    "walletInterest": m42,
    ...
    "winMoneyBigText": MessageLookupByLibrary.simpleMessage(
      "₹ 1 Lakh every week",
    ),
