...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m18(percentage) => "with ${percentage}% returns";

  static String m19(prizeAmount) =>
      "I\'ve won ₹\$${prizeAmount} as\nDigital Gold on Fello!";

  static String m20(i) => "Prize \$${i}";
  ...
  static String m24(amount) => "Claim ${amount} referral bonus by saving";

  static String m25(servingSize) => "*Based on ${servingSize} fl. oz serving.";
  ...
  static String m28(type) => "with Fello ${type}";

  static String m29(goldAmount) => "${goldAmount} gm";
  ...
  static String m32(count) => "Tickets ${count}";

  static String m33(cost) => "SKIP WITH ${cost} TOKENS";

  static String m34(date) => "Started on ${date}";

  static String m35(prize) => "Complete ${prize} to get ";

  static String m36(ticketGenerateCount) =>
      "of your ${ticketGenerateCount} tickets";

  static String m37(multiplicationFactor) => "${multiplicationFactor}X Tickets";

  static String m38(username) =>
      "Your username ${username} has been successfully registered!";

  static String m39(interest) => "${interest} % Returns on your investment";

  static String m40(ticketType, rewardAmount) =>
      "Win a ${ticketType} Card worth upto ₹${rewardAmount}";

  static String m41(prize) => "Winnings can be redeemed on reaching ₹${prize}";

  static String m42(timePeriod) => "Your Money in ${timePeriod} Years";
