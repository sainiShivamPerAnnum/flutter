...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "obUsernameRule1" : MessageLookupByLibrary.simpleMessage("must be more than 4 and less than 20 characters."),
    "obUsernameRule2" : MessageLookupByLibrary.simpleMessage("only lowercase alphabets, numbers and dot(.) are allowed."),
    "obUsernameRule3" : MessageLookupByLibrary.simpleMessage("consecutive dot(.) or dot(.) in the beginning are not valid."),
