...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(currentDay) => "दावा करने का दिन ${currentDay} इनाम";

  static String m6(prizeAmount) => "रु.${prizeAmount} तक जीतें";

  static String m7(Value) => "हर ₹${Value} की बचत पर एक टिकट पाएं";

  static String m9(index) => "माइलस्टोन ${index}";

  static String m11(amount) => "अधिकतम राशि - ₹${amount}";

  static String m14(amount) => "न्यूनतम राशि - ₹${amount}";

  static String m15(name) => "नमस्ते ${name}";

  static String m16(mobileNumber) => "लॉगिन करें +91-${mobileNumber}";

  static String m17(percentage) => "${percentage}% रिटर्न्स के साथ";

  static String m18(prizeAmount) =>
      "मैंने फेलो पर डिजिटल गोल्ड के रूप में ₹\$${prizeAmount} जीती है!";

  static String m19(i) => "पुरस्कार \$${i}";
  ...
  static String m22(refUnlock) =>
      "आपकी जीत को रिडीम करने के लिए ₹ ${refUnlock} की बचत आवश्यक है।";

  static String m23(amount) => "बचत करके ${amount} रेफरल बोनस प्राप्त करें";

  static String m24(servingSize) => "*${servingSize} fl पर आधारित। ओज सेवारत.";

  static String m25(quantity, formattedNumber) =>
  ...
  static String m27(type) => "फेलो ${type} के साथ";

  static String m28(goldAmount) => "${goldAmount} ग्राम";

  static String m29(winningsAmout) => "₹ ${winningsAmout}";

  static String m30(returns) =>
      "इस SIP से आप 5 वर्षों में ₹${returns} तक कमा सकते हैं";

  static String m31(count) => "टिकट ${count}";

  static String m32(cost) => "${cost} टोकन के साथ छोड़ें";

  static String m33(date) => "${date} को शुरू किया गया";

  static String m34(prize) => "पूरा ${prize} पाने के लिए";

  static String m35(ticketGenerateCount) => "आपके ${ticketGenerateCount} टिकट";

  static String m37(username) =>
      "आपका उपयोगकर्ता नाम ${username} सफलतापूर्वक पंजीकृत हो गया है!";

  static String m38(ticketType, rewardAmount) => "एक ${ticketType} टिकट जीतें";

  static String m39(prize) =>
      "जीत को ₹${prize} तक पहुंचने पर रिडीम किया जा सकता है";

  static String m40(timePeriod) => "${timePeriod} वर्षों में आपका पैसा";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "redeemAmznGiftVchr": m20,
        "redeemDigitalGold": m21,
        ...
        "resultsPageFirstDisclaimer": m24,
        "resultsPageLethalDosageMessage": m25,
        "resultsPageSafeDosageMessage": m26,
