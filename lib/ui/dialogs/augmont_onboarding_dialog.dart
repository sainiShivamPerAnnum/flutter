...
class AugmontOnboardingState extends State<AugmontOnboarding> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(child: dialogContent(context)),
    ...
    return Stack(
        ...
        children: <Widget>[
          SingleChildScrollView(
            ...
            child: Padding(
                padding:
                EdgeInsets.only(top: 20, bottom: 40, left: 35, right: 35),
                child: Column(
                  ...
                  children: [
                    ...
                    InputField(
                      child: TextFormField(
                        decoration:
                        inputFieldDecoration('Your bank account number'),
                    ...
                    InputField(
                      child: TextFormField(
                        decoration:
                        inputFieldDecoration('Your bank\'s IFSC code'),
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () {
                            ...
                            stateChosenValue.isEmpty) {
                              ...
                              baseProvider.showNegativeAlert(
                                  'Name missing',
                                  'Kindly enter your bank IFSC code',
                                  context);
                              return;
                            }
                            widget.onSubmit({
