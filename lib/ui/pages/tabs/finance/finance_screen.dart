      ...
      children: [
                      ...
                      return Center(
                        child: Material(
                          ...
                          child: Stack(
                            children: [
                              Center(child: FCard(
                                isClaimed: userFundWallet
                                    .isPrizeBalanceUnclaimed(),
                                unclaimedPrize: userFundWallet.unclaimedBalance,
                              )),
                            ],
                          ),
                        ),
        ...
        Container(
          child: PieChart(
            ...
            ringStrokeWidth: 5,
            centerText: "₹ ${userFundWallet.getEstTotalWealth().toStringAsFixed(
                2)}",
