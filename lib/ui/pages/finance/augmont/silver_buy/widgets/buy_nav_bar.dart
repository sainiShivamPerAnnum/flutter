...
import 'package:felloapp/ui/pages/finance/augmont/silver_buy/widgets/view_breakdown.dart';
...
class BuyNavBar extends StatelessWidget {
  ...
  void _openPaymentSheet({
    ...
    final amt = model.silverAmountController?.text;
  ...
  ///   then opens up [SilverBreakdownView] with net-banking configuration.
  ...
  ///   [SilverBreakdownView] with psp payment mode configuration.
