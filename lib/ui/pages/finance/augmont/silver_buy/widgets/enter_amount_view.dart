...
import 'package:felloapp/ui/pages/static/silver_rate_card.dart';
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyles.rajdhaniB.title0.colour(
                                  model.silverAmountController!.text == "0"
                            ...
                            AnimatedContainer(
                              ...
                              child: TextFormField(
                                ...
                                showCursor: true,
                                controller: model.silverAmountController,
                                focusNode: model.buyFieldNode,
                                enabled: !txnService.isSilverBuyInProgress &&
              ...
              child: Row(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "${model.silverAmountInGrams} ${locale.gms}",
                  ...
                  NewCurrentSilverPriceWidget(
                    fetchSilverRates: model.fetchSilverRates,
                    silverprice: model.silverRates != null
