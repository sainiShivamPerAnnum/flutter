        ...
        Column(
          ...
          children: [
            ...
            LendBoxAppBar(
              ...
              trackClosingEvent: AppState.backButtonDispatcher!.didPopRoute,
              assetName: 'Fello Flo',
            ),
            ...
            LendboxAmountInputView(
              ...
              maxAmount: model.withdrawableQuantity?.amount ?? 11,
              maxAmountMsg: locale.txnWithDrawLimit,
              minAmount: model.minAmount.toDouble(),
