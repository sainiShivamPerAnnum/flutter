...
class _Flexi6Section extends StatelessWidget {
  const _Flexi6Section({
...
class _Flexi3Section extends StatelessWidget {
  const _Flexi3Section({
    required this.seeAll,
...
class _Faqs extends StatefulWidget {
  const _Faqs({
    required this.faqs,
  });
  ...
  @override
  State<_Faqs> createState() => _FaqsState();
}

class _FaqsState extends State<_Faqs> {
...
class _CustomerSupportWidget extends StatelessWidget {
  const _CustomerSupportWidget({
    required this.is12,
  });
  final bool is12;
...
class _FlexiSection extends StatelessWidget {
  const _FlexiSection();
