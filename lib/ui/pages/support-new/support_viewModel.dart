...
import 'package:felloapp/ui/pages/support-new/support_components/learn.dart';
import 'package:felloapp/ui/pages/support-new/support_components/what_new.dart';
  ...
  List<Widget> getSaveViewItems(SupportViewModel smodel) {
    ...
    for (final key in DynamicUiUtils.support) {
      switch (key) {
        ...
        case "BL":
          saveViewItems.add(HelpWidget());
          break;
        case "SN":
          saveViewItems.add(FindUs());
          break;
      }
    }
