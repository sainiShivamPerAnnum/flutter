    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          ...
          Center(child: Text('New Update !', style: TextStyle(color: UiConstants.primaryColor, fontSize: SizeConfig.cardTitleTextSize, fontWeight: FontWeight.bold),)),
          SizedBox(height : SizeConfig.blockSizeVertical*2),
          Container(
            padding: EdgeInsets.all(8.0),
            width: SizeConfig.screenWidth*0.9,
            child: Text('We would like you to install the update to help you invest and play better. Click below to update.', textAlign: TextAlign.center,style: TextStyle(fontSize: SizeConfig.cardTitleTextSize*0.65, color: UiConstants.textColor),),
          ),
          SizedBox(height : SizeConfig.blockSizeVertical*5),
          Expanded(
            child: Align(
