            ...
            children: [
              ...
              Center(
                child: Text(
                  ...
                  style: TextStyles.rajdhaniSB.body2.colour(Color(0xffA0A0A0)),
                ),
              ),
              SizedBox(
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          "Status",
                          style:
                              TextStyles.sourceSans.colour(Color(0xffA9C6D6)),
                        ),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                                widget.txn.augmnt!["aGoldInTxn"].toString() +
                                    " gms",
                                style: TextStyles.sourceSans.body3)
                          ],
                        ),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                (widget.txn.couponMap!.containsKey("goldQty")
                                        ? (widget.txn.augmnt!["aGoldInTxn"] +
                                                widget
                                                    .txn.couponMap!["goldQty"])
                                            .toString()
                                        : widget.txn.augmnt!["aGoldInTxn"]
                                            .toString()) +
                                    " gms",
