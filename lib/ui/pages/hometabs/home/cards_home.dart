      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                                    ...
                                    child: Stack(
                                      children: [
                                        AnimatedPositioned(
                                          curve: curve,
                                          duration: duration,
                                          top: SizeConfig.screenWidth! * 1.4,
                                          left: isVerticalView
                                              ? 0
                                              : isHorizontalView
            ...
            Container(
              margin:
                  EdgeInsets.only(top: SizeConfig.pageHorizontalMargins * 2),
