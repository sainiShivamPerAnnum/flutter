      ...
      return Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: Center(child: Text('Walkthrough', style: Theme.of(context).textTheme.headline5.copyWith(color: UiConstants.primaryColor, fontSize : SizeConfig.largeTextSize*1.2,fontWeight: FontWeight.bold),),),)
              ],
            ),
            SizedBox(height: SizeConfig.blockSizeVertical*2.5,),
            Text('Do you want to watch a quick walkthrough to understand how Fello works? \n This can be viewed later in the help section as well.', style: TextStyle(color: UiConstants.textColor, fontSize: SizeConfig.mediumTextSize*1.4)),
            SizedBox(height : SizeConfig.blockSizeVertical*5),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
