...
class ReferralLeaderboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<LeaderboardService>(builder: (context, model, properties) {
      log("BUILD: Referral board rebuilds");
      bool showSeeAll = (model.referralLeaderBoard?.length ?? 0) > 2;
      return Container(
