...
class PrizeDialogState extends State<PrizeDialog> {
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                Expanded(
                    child: Container(
                        alignment: Alignment.center, child: _addPageView())),
                SizedBox(
                  height: 15,
                )
              ],
  ...
  Widget _buildWinnersTabView() {
    ...
    Widget _tWidget;
    if (!_winnersFetched)
      dbProvider.getWeeklyWinners().then((resWinners) {
    ...
    if (!_winnersFetched) {
      ...
      _tWidget = new Center(
        child: Padding(
          padding: EdgeInsets.all(30),
          child: Text(
            'The winner list will be updated soon',
            textAlign: TextAlign.center,
            style: TextStyle(fontSize: 24, color: UiConstants.accentColor),
          ),
        ),
      );
    } else {
        ...
        children: [
          Padding(
              ...
              child: Align(
                alignment: Alignment.topCenter,
                child: Text(
                  'Here are the winners from Week $weekCode:',
                  textAlign: TextAlign.center,
        ...
        children: [
          Expanded(
            ...
            child: Text(
              ...
              style: TextStyle(color: UiConstants.accentColor, fontSize: 22),
            ),
          )),
          Padding(
            padding: EdgeInsets.fromLTRB(10, 5, 10, 5),
